...
library RewardProofFixture {
    ...
    function proof() internal pure returns (bytes memory) {
        uint256[2] memory a =
            [uint256(11280659002573467124046355400609360568341759664737269623973849838998994104397), uint256(9560661811363739276405480678897165953780719611757080952678033551816140313945)];
        uint256[2][2] memory b = [
            [uint256(410213115740382913086954346842735073459874365496494092340160201804982416721), uint256(1693075159419918264192217717650710554250056028671858359955208271210982974700)],
            [uint256(4217820291848868205209724030209566758175709763203813744760136036254732585196), uint256(18159906001232476355464111416337268942553103232167754891225551451516561608407)]
        ];
        uint256[2] memory c =
            [uint256(526908253996588475260737066066014340169807399444882775813830449806397062845), uint256(12740186028778009356189574823974722989639423385451062494374656628961728299723)];
